...
banner = f"""{A1}
  ╔══════════════════════════════════════════════════╗
  ║                                                  ║
  ║  {A3}  ░▒▓DAKSHU X BHAVESH ▓▒░    COLLAB TOOL     {A1}  ║
  ║                                                  ║
  ╚══════════════════════════════════════════════════╝
...
sys.stdout.write(f"  {A1}║{RESET}  {A3}► TOKEN   :{A4}  ")
sys.stdout.flush()
TOKEN = input().strip()

sys.stdout.write(f"  {A1}║{RESET}  {A3}► CHAT ID :{A4}  ")
sys.stdout.flush()
CHAT_ID = input().strip()
...
class ConfigManager:
    ...
    def _show_banner(self):
        ...
        self.console.print("[bold #ff8c00]  ║[/bold #ff8c00]  [bold #ffdd00]  ░▒▓  ASHU  X  LEE  ▓▒░    COLLAB TOOL     [/bold #ffdd00]  [bold #ff8c00]║[/bold #ff8c00]")
        self.console.print("[bold #ff8c00]  ╚══════════════════════════════════════════════════╝[/bold #ff8c00]")
        self.console.print()

    def _select_year(self):
        self.console.print("[bold #ff8c00]  ╔══[ SELECT YEAR RANGE ]══════════════════════════╗[/bold #ff8c00]")
        self.console.print("[bold #ff8c00]  ║[/bold #ff8c00]")
    ...
    def _select_filter(self):
        self.console.print()
        self.console.print("[bold #ff8c00]  ╔══[ SELECT ACCOUNT TYPE ]════════════════════════╗[/bold #ff8c00]")
        self.console.print("[bold #ff8c00]  ║[/bold #ff8c00]")
...
def main():
    ...
    threads = collector.start(thread_count=100)
    ...
    try:
        ...
        display.stop()
        config.console.print("\n[bold #ff8c00]  ◄  DAKSHU X BHAVESHE  —  SESSION ENDED  ►[/bold #ff8c00]")
