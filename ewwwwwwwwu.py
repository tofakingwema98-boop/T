...
print(f"{fg_red}{bold}✈️ ہوائی جہاز موڈ آن کریں یا وی پی این تبدیل کریں{reset}")
...
╭━━━〔 ✦ 𝐈𝐍𝐒𝐓𝐀 𝐑𝐄𝐏𝐎𝐑𝐓 ✦ 〕━━━╮
┃ ✦ کل ہِٹ        ➤ {total_hits}
┃ ✦ میٹا اسٹیٹس   ➤ {meta_status}
┃ ✦ یوزرنیم       ➤ {username}
┃ ✦ میل           ➤ {username}@{domain}
┃ ✦ ری سیٹ        ➤ {rest(username)}
┃ ✦ نام           ➤ {full_name}
┃ ✦ فالوورز       ➤ {followers}
┃ ✦ فالوونگ       ➤ {following}
┃ ✦ تاریخ         ➤ [2013-2020]
...
def get_usernames():
    ...
    while True:
        try:
            ...
            if username and pk_id and followers and followers > 5:
